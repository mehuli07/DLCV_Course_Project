...
├── plot_results.py        # All figures from saved JSON results
...
- `results/partA_*.json`, `results/partB_*.json` — accuracy tables
- `results/figures/` — PDF figures (generated by `plot_results.py`)
